 ...
 *
 * @see [org.ton.block.AccountState]
 */
public data class StateInit(
     ...
     */
    val library: Dictionary<ByteString, SimpleLib>
) : CellSizeable {
    public constructor(
        code: Cell? = null,
        data: Cell? = null,
...
private object StateInitTlbCodec : TlbCodec<StateInit> {
    ...
    override fun storeTlb(
        ...
        if (value.special != null) {
            ...
            SpecialFlags.storeTlb(builder, value.special, context)
        } else {
            builder.storeBoolean(false)
        }
    ...
    override fun loadTlb(
        ...
        val special = if (slice.loadBoolean()) {
            SpecialFlags.loadTlb(slice, context)
        } else {
            null
        }
