...
public actual class AesCtr public actual constructor(key: ByteArray, iv: ByteArray) : AutoCloseable {
    private val cipher = CTRBlockCipher(Aes(key), iv)
    ...
    public actual fun processBytes(
        ...
        return cipher.processBytes(source, destination, destinationOffset, startIndex, min(endIndex, source.size))
    }
...
private interface MultiBlockCipher : BlockCipher {
    /**
...
private abstract class DefaultMultiBlockCipher : MultiBlockCipher {
...
private val SBOX1 = ubyteArrayOf(
    // @formatter:off
