...
public class BagOfCellsHeader(
    public val magic: Int,
    public val rootCount: Int,
    public val cellCount: Int,
    public val absentCount: Int,
    public val refByteSize: Int,
    public val offsetByteSize: Int,
    public val hasIndex: Boolean,
    public val hasRoots: Boolean,
    public val hasCrc32c: Boolean,
    public val hasCacheBits: Boolean,
    public val rootsOffset: Long,
