...
private const val HISTORY_BITS = 512
private const val HISTORY_SIZE = HISTORY_BITS / 64
private const val INDEX_MASK = (HISTORY_BITS / 2 - 1).toLong() // 0xFF for 512 bits
